...
object NullableExtensionOperatorWithSafeCallChecker : CallChecker {
    ...
    override fun check(resolvedCall: ResolvedCall<*>, reportOn: PsiElement, context: CallCheckerContext) {
        ...
        if (!context.isNullableSafeCallReceiver(resolvedCall.extensionReceiver)) return
    ...
    private fun CallCheckerContext.isNullableSafeCallReceiver(receiverValue: ReceiverValue?): Boolean {
